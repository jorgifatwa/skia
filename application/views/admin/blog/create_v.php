<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Berita Baru</h1>
        <p class="m-0">Berita</p>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?php echo base_url() ?>blog"></i>Berita</a></li>
            ...
            <form id="form" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" id="title" name="title" autocomplete="off" placeholder="Title">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="form-label col-sm-3" for="">Gambar</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="file" id="gambar" name="gambar" autocomplete="off" placeholder="Title">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="form-label col-sm-3" for="">Berita</label>
                        <div class="col-sm-9">
                            <textarea name="berita" id="berita" class="form-control" placeholder="Berita" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                </div>
