      ...
      <div class="col-md-8 bg-login h-100">
        <div class="login-illustration h-100">
          <div class="login-flex">
            <img src="<?php echo base_url();?>assets/images/logo_skia.png">
            <h5 class="greeting">Selamat Datang di <br><span>Aplikasi Pengelolaan Keuangan SKIA</span></h5>
          ...
          <div class="mt-3">
            <div class="">
              <form action="<?php echo base_url();?>auth/login" method="post" id="form-login">
                ...
                <button class="btn btn-darkblue btn-block" style="background: #365468 !important;" id="btn-login">Login</button>
              </form>
              <div class="row">
                <!-- <div class="col-12">
