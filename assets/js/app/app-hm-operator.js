define([
    ...
    return {
        ...
        initData: function (tahun = null, bulan = null, lokasi = null, type = "day"){
            $.ajax({
                url: App.baseUrl + 'report/grafikHmByOperator',
                type: 'POST',
                data: {
                    tahun: tahun,
                    bulan: bulan,
        ...
        initGrafik: function(kategori = null, data = null){
            Highcharts.chart('grafik_operator', {
                chart: {
                    type: 'column',
                    zoomType: 'xy',
                    marginTop: 20,
